...
public class PlayerInteractions : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.F) && hasItem && Physics.Raycast(interactionRay, out hit, pickUpDistance, itemFramesLayerMask))
        {
            ...
            // Esto fue lo que se me ocurrió en el momento y no estoy seguro de que sea la mejor soluci�n,
            // pero por ahora funciona
            //
            // UPDATE: cuando tome la decision de hacer el raycast en capas distintas, solo dios y yo
            // sabbíamos lo que estabamos haciendo y por alguna razon ninguno de los dos pensó en comentar
            // el razonamiento detrás de esa desición. Ahora, solo dios sabe el por qué...

            // To Do: Quizas haya que implementar un controlador para los item frames para
            // aplicar la logica de "desempaquetar" las cajas. Eso probablemente cambiar�a esta l�gica.
            Debug.Log(hit.collider.gameObject.name);
